  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u0" class="ax_图片">
        <img id="u0_img" class="img " src="images/主页/u0.JPG"/>
        <!-- Unnamed () -->
      ...
      <div id="u2" class="ax_图片">
        <img id="u2_img" class="img " src="images/主页/u2.jpg"/>
        <!-- Unnamed () -->
      ...
      <div id="u4" class="ax_图片">
        <img id="u4_img" class="img " src="images/主页/u4.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u8" class="ax_图片">
        <img id="u8_img" class="img " src="images/主页/u8.jpg"/>
        <!-- Unnamed () -->
